...
const Hero = () => {
    return (
        <Container maxW="container.xl" paddingTop="150px" centerContent>
            <VStack textAlign="center" py={16} bgGradient="linear(to-b, yellow.900, black)" borderRadius="2xl" p={8}>
                ...
                <Button mt={6} bg="yellow.500" color="black" fontWeight="bold" px={6} py={3} borderRadius="xl" onClick={() => window.location.href = '/'}>
                    Start Exploring
                </Button>
            </VStack>
        </Container>
