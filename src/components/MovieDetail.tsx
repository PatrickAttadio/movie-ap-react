...
const MovieDetail = () => {
  ...
  const { image, title, description, adult, release_date, genre_ids, vote_average } = getCardData(content, contentType || "");
...
const getCardData = (content: ContentType | null, type: string) => {
  ...
  return { image, title, description, adult, release_date, genre_ids, vote_average };
};
